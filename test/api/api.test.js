...
describe('API', () => {
  test('should return 404 for GETs to nonexistent API endpoints', async () => {
    await test404('get', '/api/nonexistent', '/api/nonexistent');
  });

  test('should return 404 for POSTs to nonexistent API endpoints', async () => {
    await test404('post', '/api/nonexistent', '/api/nonexistent');
  });

  test('should return 200 for /healthz', async () => {
